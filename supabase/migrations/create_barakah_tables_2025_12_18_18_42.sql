...
-- Create RLS Policies
CREATE POLICY "Users can view own finance data" ON public.finance_data_2025_12_18_18_42
    FOR ALL USING (auth.uid() = user_id);

CREATE POLICY "Users can view own logistics data" ON public.logistics_data_2025_12_18_18_42
    FOR ALL USING (auth.uid() = user_id);

CREATE POLICY "Users can view own spiritual data" ON public.spiritual_data_2025_12_18_18_42
    FOR ALL USING (auth.uid() = user_id);

CREATE POLICY "Users can view own academic data" ON public.academic_data_2025_12_18_18_42
    FOR ALL USING (auth.uid() = user_id);

CREATE POLICY "Users can view own system data" ON public.system_data_2025_12_18_18_42
    FOR ALL USING (auth.uid() = user_id);

CREATE POLICY "Users can view own legislation data" ON public.legislation_data_2025_12_18_18_42
    FOR ALL USING (auth.uid() = user_id);

CREATE POLICY "Users can view own psychosocial data" ON public.psychosocial_data_2025_12_18_18_42
    FOR ALL USING (auth.uid() = user_id);

CREATE POLICY "Users can view own health data" ON public.health_data_2025_12_18_18_42
    FOR ALL USING (auth.uid() = user_id);
