...
const HidayaAppointmentManager: React.FC = () => {
    ...
    const fetchAppointments = async () => {
        ...
        try {
            ...
            if (data) {
                ...
                localStorage.setItem('hidaya_appointments_cache', JSON.stringify(mappedAppointments));
            }
        } catch (error) {
...
export default HidayaAppointmentManager;
