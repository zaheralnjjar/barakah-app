...
function ChangeView({ center, zoom }: any) {
    ...
    useEffect(() => {
        ...
        // Fix for map rendering issues when container size changes or tab switches
...
const InteractiveMap = () => {
    ...
    // Memoize markers to avoid hook-in-conditional error
    const markers = React.useMemo(() => savedLocations.map((loc: any) => {
