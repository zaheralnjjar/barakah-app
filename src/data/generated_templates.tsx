    ...
    // --- 4. Personal / Lifestyle (10) ---
    {
        ...
        content: `
            <table style="width: 100%; text-align: center; font-size: 0.9em; border-collapse: collapse;">
                ...
                <tbody>
                    <tr><td style="border: 1px solid #e5e7eb; text-align: right; padding-right: 5px;">شرب الماء</td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td></tr>
                    <tr><td style="border: 1px solid #e5e7eb; text-align: right; padding-right: 5px;">القراءة</td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td></tr>
                     <tr><td style="border: 1px solid #e5e7eb; text-align: right; padding-right: 5px;">الرياضة</td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td><td style="border: 1px solid #e5e7eb;"><input type="checkbox"></td></tr>
                </tbody>
            </table>
        `
    },
